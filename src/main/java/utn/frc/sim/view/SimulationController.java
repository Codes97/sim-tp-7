...
//        String litrosCD2 = simulation.getDarsena2ClientCapacity();
        ...
        stateAreaA.setCellValueFactory(new PropertyValueFactory<>("estadoAreaA"));
        ...
        stateAreaB.setCellValueFactory(new PropertyValueFactory<>("estadoAreaB"));
        ...
        stateS1.setCellValueFactory(new PropertyValueFactory<>("estadoSecado1"));
        clienteS1.setCellValueFactory(new PropertyValueFactory<>("clienteSecado1"));
        endS1.setCellValueFactory(new PropertyValueFactory<>("endS1"));
        stateS2.setCellValueFactory(new PropertyValueFactory<>("estadoSecado2"));
        clienteS2.setCellValueFactory(new PropertyValueFactory<>("clienteSecado2"));
        endS2.setCellValueFactory(new PropertyValueFactory<>("endS2"));
        stateS3.setCellValueFactory(new PropertyValueFactory<>("estadoSecado3"));
        clienteS3.setCellValueFactory(new PropertyValueFactory<>("clienteSecado3"));
        endS3.setCellValueFactory(new PropertyValueFactory<>("endS3"));
        stateS4.setCellValueFactory(new PropertyValueFactory<>("estadoSecado4"));
        clienteS4.setCellValueFactory(new PropertyValueFactory<>("clienteSecado4"));
        endS4.setCellValueFactory(new PropertyValueFactory<>("endS4"));
        stateS5.setCellValueFactory(new PropertyValueFactory<>("estadoSecado5"));
        clienteS5.setCellValueFactory(new PropertyValueFactory<>("clienteSecado5"));
